...
# Quantization without KD, refering to Method A
...
export STUDENT_MODEL_DIR=output_A/Ternary_W2A4/${TASK_NAME}/kd_stage2/ 
...
python benn_glue_train_A.py \
    ...
    --learnable_scaling \
    --is_binarybert \
    --split 2>&1 | tee -a nohup_out/${TASK_NAME}_A.out